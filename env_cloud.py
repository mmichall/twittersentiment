...
DATASET_PATH = '/data/resources/dataset'
DEEPMOJI_WEIGHTS = '/data/resources/deepmoji/deepmoji_weights.hdf5'
DEEPMOJI_VOCAB = '/data/resources/deepmoji/vocabulary.json'
