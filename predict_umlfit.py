...
import sys
sys.path.insert(0, "\\script\\fastai\\old")
...
def predict_input(itos_filename, trained_classifier_filename, text, num_classes=2):
    """
...
if __name__ == '__main__':
    trained_classifier_filename = '/data/umlfit_data/models/fwd_pretrain_wt103_clas_1.h5'
    itos_filename = '/data/umlfit_data/tmp/itos.pkl'
    ...
    stoi, model = load_model(itos_filename, trained_classifier_filename, 2)
    ...
    for text in sem_eval_dataset.iterate_test_x():
        print(predict_text(stoi, model, text))
